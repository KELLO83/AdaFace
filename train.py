...
def parser():
    ...
    parser.add_argument('--backbone_lr', type=float, default=1e-3, help='Optional override for backbone learning rate (defaults to --lr).')
    parser.add_argument('--head_lr', type=float, default=1e-2, help='Optional override for head learning rate (defaults to --lr).')
